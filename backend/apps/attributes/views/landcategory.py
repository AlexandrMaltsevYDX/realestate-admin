...
class LandCategoryModelViewSet(viewsets.ModelViewSet):
    queryset = models.LandCategory.objects.all()
    serializer_class = serializers.LandCategoryModelSerializer

    @extend_schema(
        description="Custom description for the endpoint",
        tags=("attributes-land-category",),
    )
